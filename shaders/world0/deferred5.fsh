...
void main() {
	...
	if (depth >= 1.0 && materialID != 36) {
		...
		// =============================================================================
		// ВАНИЛЬНАЯ ЛОГИКА ПЕЩЕР
		// =============================================================================
		bool hasSkyAccess = mcLightmap.g > 0.05; // Доступ к небу?
		...
		// ИСПРАВЛЕНО: SSS только если есть доступ к небу
		if (sssAmount > 1e-4 && hasSkyAccess) {
		...
		// =============================================================================
		// ИСПРАВЛЕНО: Тени и спекуляр только если есть доступ к небу
		// =============================================================================
		if (NdotL > 1e-3 && hasSkyAccess) {
		...
		// =============================================================================
		// ИСПРАВЛЕНО: GI и bounce light только если есть доступ к небу
		// =============================================================================
